...
int main(void)
{
    ...
    else if(userin>100000000000000 && userin<999999999999999 &&(userin/10000000000000==34 ||userin/10000000000000==37  )){

    long long int ansone  = userin%100000000000000/10000000000000;
    long long int anstwo= userin%1000000000000/100000000000;
    long long int ansthree = userin%10000000000/1000000000;
    long long int ansfour = userin%100000000/10000000;
    long long int ansfive = userin%1000000/100000;
    long long int anssix = userin%10000/1000;
    long long int ansseven = userin%100/10;
    long long int i = userin%1000000000000000/100000000000000;
    long long int j = userin%10000000000000/1000000000000;
    long long int k = userin%100000000000/10000000000;
    long long int l = userin%1000000000/100000000;
    ...
    int f=multiplyer(anssix);
    int g=multiplyer(ansseven);
    int total = a + b + c + d + e + f+ g + i + j + k + l+ m + n + o + p;
    int checksum = total % 10;
    //printf("%i",total);//
    if(checksum == 0){
    ...
    else if(((userin>100000000000000 && userin<999999999999999) || (userin>1000000000000000 && userin<9999999999999999) || (userin>10000000000000 && userin<99999999999999) ||
    (userin>1000000000000 && userin<9999999999999)) && ( userin/1000000000000000==4  || userin/100000000000000==4 || userin/10000000000000==4 || userin/1000000000000==4 )){
